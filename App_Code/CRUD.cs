   ...
   public class CRUD
    {
       // public string myVar2 = "Saudi Arabia";
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["reema7266eConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["reema7266eConStr"].ConnectionString);
        public CRUD()
        {
            //
        ...
        public static implicit operator SqlDataReader(CRUD v)
        {
